...
public final class ImageScannerController: UINavigationController {
    ...
    /// Options
    private var singlePageAutoScan = false
    private var pause = false
    private var ratio: Double?
    private var hideButtons: Bool {
        singlePageAutoScan
    }
    ...
    public required init(image: UIImage? = nil, delegate: ImageScannerControllerDelegate? = nil, singlePageAutoScan: Bool = false, pause: Bool = false, ratio: Double? = nil) {
        self.singlePageAutoScan = singlePageAutoScan
        self.pause = pause
        self.ratio = ratio
        let scannerViewController = ScannerViewController()
        scannerViewController.pause = pause
        scannerViewController.singlePageAutoScan = singlePageAutoScan
        scannerViewController.ratio = ratio
